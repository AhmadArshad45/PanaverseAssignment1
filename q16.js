var guestlist3 = ["Dr Muhammad Iqbal", "Nusrat Fateh Ali Khan", 'Jaun Elia', 'Virat Kohli'];
...
while (guestlist3.length > 2) {
    var name_1 = guestlist3.pop();
    console.log("Sorry you are not invited to Dinner", name_1);
}
